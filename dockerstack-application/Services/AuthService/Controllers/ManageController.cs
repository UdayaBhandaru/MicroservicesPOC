// <copyright file="ManageController.cs" company="Agility E Services">
...
namespace Agility.Framework.IdentityServer.Controllers
{
    ...
    using Agility.Framework.IdentityServer.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                this.urlEncoder.Encode("IdentityServer"),
